...
#if(HEADER_APP_FADDR==65)
#define OAD_BLOCK_APP_MAX        (0xCD0)  //(44K *1024*4) /64
#define SEC_IMAGE_OAD_HEADER_APP_FADDR    (0x10410)
#define SEC_BACKUP_OAD_HEADER_FADDR		 (0x1C000) //112kb * 1024
#define SEC_BACKUP_ALLOC_START_FADDR		 (0x1C000) //(112KB)
#else
#define OAD_BLOCK_APP_MAX        (0x880)  //(44K *1024*4) /64
#define SEC_IMAGE_OAD_HEADER_APP_FADDR    (0x17010)
#define SEC_BACKUP_OAD_HEADER_FADDR		 (0x1F800) //118kb * 1024
#define SEC_BACKUP_ALLOC_START_FADDR		 (0x1F800) //(118KB)


#endif
#define SEC_BACKUP_ALLOC_END_FADDR		 (0x27F00) //(159KB)
/*********************************************************************
 * MACROS
 */   
